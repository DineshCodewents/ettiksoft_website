...
@Component({
  selector: 'app-emi-wiring-testing',
  templateUrl: './emi-wiring-testing.component.html',
  styleUrls: ['./emi-wiring-testing.component.css']
})
export class EmiWiringTestingComponent {
